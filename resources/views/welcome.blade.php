...
<head>
    ...
    <title>The Highest Place real estate </title>
...
<body id="top">
    <div class="header">
        <div class="container">
            ...
            <ul class="navbar-list">
                ...
                <li><a href="invest.html" class="navbar-link">Investment</a></li>
            ...
            <div class="header-buttons">
                <button class="button5" id="get-started">Let’s Get Started</button>
    ...
    <div id="form-container" style="display: none;">
        <form id="auth-form">
            ...
            <h2 id="form-title">Log in or create an account</h2>
            ...
            <button type="button" class="social-btn facebook-btn">Continue with Facebook</button>
            <button type="button" class="social-btn apple-btn">Continue with Apple</button>
            <button type="button" class="social-btn email-btn">Email Me a Link</button>
            <p class="agent-prompt">Are you a real estate agent? <a href="#">Log in or create an account here</a>
            </p>
        </form>
    </div>
    </header>
                ...
                <div class="container">
                    ...
                    <div class="hero-bg">
                        <div class="hero-content">
                            ...
                            <p class="hero-text">
                                A great platform for buying, selling, and renting properties in the UAE without agents
                                or commissions.
                            </p>
                    ...
                    <section class="section about" aria-label="about">
                        <div class="container">
                            ...
                            <div class="about-banner img-holder" style="--width: 600; --height: 700;">
                                <img src="./assets/images/about-banner.jpg" width="600" height="700"
                            ...
                            <div class="about-content">
                                ...
                                <p class="section-text">
                                    Hously developed a platform for the Real Estate marketplace that allows buyers and
                                    sellers to easily
                                    execute a
                                    transaction on their own. The platform drives efficiency, cost transparency and
                    ...
                    <section class="section service" aria-label="service">
                        <div class="container">
                            ...
                            <h2 class="h2 section-title">See How It Work</h2>
                            ...
                            <ul class="service-list">
                                ...
                                <li>
                                    <div class="service-card">
                                        ...
                                        <p class="card-text">
                                            Assess the property's value, location, and condition to make a well-informed
                                ...
                                <li>
                                    <div class="service-card">
                                        ...
                                        <p class="card-text">
                                            Meet with the agent to clarify property details, ask essential questions,
                                            and ensure transparency in the deal.
                                        </p>
                                ...
                                <li>
                                    <div class="service-card">
                                        ...
                                        <p class="card-text">
                                            Ensure all contract details are complete, negotiate effectively,
                                            and confirm legal requirements for a smooth transaction.
                                        </p>
                            ...
                            <ul class="property-list">
                                ...
                                <li>
                                    <div class="property-card">
                                        ...
                                        <figure class="card-banner img-holder" style="--width: 800; --height: 533;">
                                            <img src="./assets/images/property-1.jpg" width="800" height="533"
                                                loading="lazy" alt="10765 Hillshire Ave, Baton Rouge, LA 70810, USA"
                                                class="img-cover">
                                        </figure>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <a href="#" class="card-title">10765 Hillshire Ave, Baton Rouge,
                                                    LA 70810, USA</a>
                                            </h3>
                                ...
                                <li>
                                    <div class="property-card">
                                        ...
                                        <figure class="card-banner img-holder" style="--width: 800; --height: 533;">
                                            <img src="./assets/images/property-2.jpg" width="800" height="533"
                                                loading="lazy" alt="59345 STONEWALL DR, Plaquemine, LA 70764, USA"
                                                class="img-cover">
                                        </figure>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <a href="#" class="card-title">59345 STONEWALL DR, Plaquemine,
                                                    LA 70764, USA</a>
                                            </h3>
                                ...
                                <li>
                                    <div class="property-card">
                                        ...
                                        <figure class="card-banner img-holder" style="--width: 800; --height: 533;">
                                            <img src="./assets/images/property-3.jpg" width="800" height="533"
                                                loading="lazy" alt="3723 SANDBAR DR, Addis, LA 70710, USA"
                                                class="img-cover">
                                        </figure>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <a href="#" class="card-title">3723 SANDBAR DR, Addis, LA 70710,
                                                    USA</a>
                                            </h3>
                                ...
                                <li>
                                    <div class="property-card">
                                        ...
                                        <figure class="card-banner img-holder" style="--width: 800; --height: 533;">
                                            <img src="./assets/images/property-4.jpg" width="800" height="533"
                                                loading="lazy" alt="LOT 21 ROYAL OAK DR, Prairieville, LA 70769, USA"
                                                class="img-cover">
                                        </figure>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <a href="#" class="card-title">LOT 21 ROYAL OAK DR,
                                ...
                                <li>
                                    <div class="property-card">
                                        ...
                                        <figure class="card-banner img-holder" style="--width: 800; --height: 533;">
                                            <img src="./assets/images/property-5.jpg" width="800" height="533"
                                                loading="lazy"
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <a href="#" class="card-title">710 BOYD DR, Unit #1102, Baton
                                                    Rouge, LA 70808, USA</a>
                                            </h3>
                                ...
                                <li>
                                    <div class="property-card">
                                        ...
                                        <figure class="card-banner img-holder" style="--width: 800; --height: 533;">
                                            <img src="./assets/images/property-6.jpg" width="800" height="533"
                                                loading="lazy" alt="5133 MCLAIN WAY, Baton Rouge, LA 70809, USA"
                                                class="img-cover">
                                        </figure>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <a href="#" class="card-title">5133 MCLAIN WAY, Baton Rouge, LA
                                                    70809, USA</a>
                                            </h3>
                        ...
                        <div class="container">
                            ...
                            <form action="" class="newsletter-form">
                                <input type="email" name="email_address" placeholder="Enter your email :"
                                    aria-label="Enter your email" required class="email-field">
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <p class="copyright">
                    &copy; 2024 Realvine. All Right Reserved by <a href="#" class="copyright-link"></a>.
                </p>
